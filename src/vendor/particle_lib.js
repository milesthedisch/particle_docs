...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	Vector.prototype.rotate = function (π) {
	  var cos = Math.cos(π);
	  var sin = Math.sin(π);
	  this.state.x = this.state.x * cos - this.state.y * sin;
	  this.state.y = this.state.y * cos + this.state.x * sin;
	};
